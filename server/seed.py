...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        p1 = Product(name='NextBigThing', price=1500, description=desc, image='../assets/product_images/nbt-product-img-og.jpg', specs=specs)
        p2 = Product(name='NextBigThing Pro', price=2200, description=descPro, image='../assets/product_images/nbt-product-img-pro.jpg', specs=specsPro)
        p3 = Product(name='NextBigThing Lite', price=950, description=descLite, image='../assets/product_images/nbt-product-img-lite.jpg', specs=specsLite)
        products = [p1, p2, p3]
        ...
        r2 = Review(name='Erlich Bachman', title='co-founder of Bachmanity', body="I've seen the evolution of tech, and theNextBigThing is a meteoric leap into the future. Its enigmatic features are like portals to another dimension of connectivity and exploration - a true game changer in the tech world.", image='https://media.licdn.com/dms/image/C5603AQEpsWILQiAJpQ/profile-displayphoto-shrink_800_800/0/1517071448491?e=2147483647&v=beta&t=1AE7yTpjxF_krVvVz35XTc8SNdPZ-LnYWeuYFIWG73Q')
        r3 = Review(name='Michael G. Scott', title='author of "Somehow I Manage"', body="Just as words craft worlds in literature, theNextBigThing crafts possibilities in the realm of technology. It's a narrative of progress that leaves users spellbound, turning each interaction into a chapter of discovery.", image='https://assetsio.reedpopcdn.com/Michael-Scott-in-Mass-Effect.jpg?width=1200&height=1200&fit=crop&quality=100&format=png&enable=upscale&auto=webp')
        r4 = Review(name='Tony Perkis, Jr.', title='fitness entrepreneur', body="In the world of wellness, theNextBigThing is the ultimate workout for your mind and imagination. It's like a personal trainer that guides you through the realms of unexplored potential, transforming aspirations into tangible achievements.", image='https://resizing.flixster.com/5R4-I9vX722dfm4KeZ5qfnRG_jY=/300x300/v2/https://flxt.tmsimg.com/assets/p16488_i_h10_ab.jpg')
